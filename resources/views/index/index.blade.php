            ...
            <ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
                <li class="yui3-u-1-6">
                    <dl class="picDl huozhe">
                        ...
                        <dd>
                            <a href="" class="pic"><img src="/asses/img/like_01.png" alt="" /></a>
                            <div class="like-text">
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl tuhua">
                        ...
                        <dd>
                            <a href="" class="pic"><img nsrc="assets//asses/img/like_02.png" alt="" /></a>
                            <div class="like-text">
                                <p>三星（G5500）</p>
                                <p>移动联通双网通</p>
                                <h3>¥566.00</h3>
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl jilu">
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="/asses/img/like_03.png" alt="" /></a>
                            <div class="like-text">
                                <p>捷波朗 </p>
                                <p>（jabra）BOOSI劲步</p>
                                <h3>¥236.00</h3>
                        ...
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="/asses/img/like_02.png" alt="" /></a>
                            <div class="like-text">
                                <p>欧普</p>
                                <p>JYLZ08面板灯平板灯铝</p>
                                <h3>¥456.00</h3>
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl tuhua">
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="/asses/img/like_01.png" alt="" /></a>
                            <div class="like-text">
                                <p>三星（G5500）</p>
                                <p>移动联通双网通</p>
                                <h3>¥566.00</h3>
                        ...
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img nsrc="assets//asses/img/like_02.png" alt="" /></a>
                            <div class="like-text">
