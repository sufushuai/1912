...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/asses/css/pages-list.css" />
        ...
        <div class="clearfix selector">
            ...
            <div class="type-wrap logo">
                ...
                <div class="value logos">
                    <ul class="logo-list">
                        @foreach($brand as $v)
                        <li><img src="{{env('UPLOAD_URL')}}{{$v->brand_logo}}" /></li>
                        @endforeach
                    </ul>
                </div>
                <div class="ext">
            ...
            <div class="goods-list">
                <ul class="yui3-g">
                    <li class="yui3-u-1-5">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="/asses/img/_/mobile05.png" />
                            </div>
                            <div class="price">
                                <strong>
                                    <em>¥</em>
                    ...
                    <li class="yui3-u-1-5">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="/asses/img/_/mobile06.png" />
                            </div>
                            <div class="price">
                                <strong>
                                    <em>¥</em>
                    ...
                    <li class="yui3-u-1-5">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="/asses/img/_/mobile01.png" />
                            </div>
                            <div class="price">
                                <strong>
                                    <em>¥</em>
                    ...
                    <li class="yui3-u-1-5">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="/asses/img/_/mobile02.png" />
                            </div>
                            <div class="price">
                                <strong>
                                    <em>¥</em>
                    ...
                    <li class="yui3-u-1-5">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="/asses/img/_/mobile03.png" />
                            </div>
                            <div class="price">
                                <strong>
                                    <em>¥</em>
